                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {transactions.map((transaction) => (
                    <tr key={transaction.id}>
                      ...
                      <td className="whitespace-nowrap px -2 py-2 text-sm text-gray-900">{transaction.phone}</td>
                      <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-500">{transaction.city}</td>
                      ...
                      <td className="relative whitespace-nowrap py-2 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="/" className="text-indigo-600 hover:text-indigo-900">
                          details<span className="sr-only">, {transaction.id}</span>
                        </a>
                      </td>
                    </tr>
                  ))}
